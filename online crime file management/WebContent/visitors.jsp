...
<p><h4 style="color:white"><b>VISITOR LOGIN</b></h4></p>
</font>
...
<input type="hidden" name="table" value="ologin">
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="submit" value="submit">   <input type="submit" value="clear"><br/>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="verdana" color="white"> To register,click on </font><a href="vreg.jsp"><font style="color:red">Register</font></a>
      </form>
