...
String uid=(String)session.getAttribute("uid");
					...
					int k = 0;
					String s = "pending";
					String sql = "select * from ureg where id=? ";
		...
		<center>	
				<p><h4 style="color:white"><b>Registration Details</b></h4></p>
				<form name="f1" action="creg1.jsp" method="POST" onsubmit="return validation()">
...
<tr>
 ...
 <tr>
     <td style="color:white">Password</td><td><input type="password" value=<%=b%> name="t2" readonly></td>
 </tr> 
 <tr>
       <td style="color:white">mail id</td><td><input type="text" value=<%=d%> name="t4"></td> 
 </tr> 
 <tr>
       <td style="color:white">Mobile no</td><td><input type="text" value=<%=c%> name="t3"></td> 
 </tr>
...
<option value="female">female</option>
 ...
 <tr>
       <td style="color:white">Address</td><td><input type="text" value=<%=f%> name="t6"> </td>
 </tr> 
 <tr>
      <td style="color:white">Colony</td><td><input type="text" value=<%=g%> name="t7"> </td>
</tr>
</table>
<input type="hidden" name="table" value="registration4">
