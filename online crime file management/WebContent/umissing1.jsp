...
PreparedStatement ps1=con.prepareStatement("select * from umissing where id=?");
	ps1.setString(1, uid);
	...
	<th style="color:white">FIR status</th>
	<th style="color:white">Case status</th>
	...
	<td style="color:white"><%=rs.getString(16)%></td>
	<td style="border: 1px solid black">
	
	<a href="creg1.jsp?t1=<%=rs.getString(14)%>&table=del3">delete</a>
	</td> 
