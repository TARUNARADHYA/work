...
<col width="130">
  <col width="80">
<tr>
     <td style="color:white">User name</td><td><input type="text" name="t1" required> </td>
 </tr> 
 <tr>
     <td style="color:white"> Detail suspect</td><td><input type="text" name="t2" required></td>
 </tr> 
  <tr>
       <td style="color:white">Description</td><td><textarea name="t3" required></textarea></td>
 </tr>
 
 <tr >
       <td style="color:white">Date of complaint</td> <td><input type="date" width=100% name="t4" required> </td>
 </tr>
 
 <tr>
      <td style="color:white" width=50%>Type of crime</td><td><select name="t5" required>
...
<input type="hidden" name="table" value="registration2">
