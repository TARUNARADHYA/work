            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                    <li class="current_page_item"><a href="index.html"
						accesskey="1" title=""><h4 style="color:red">Home</h4></a></li>
					<li><a href="vhot.jsp" accesskey="5" title=""><h4 style="color:red">VIEW HOTNEWS</h4></a></li>
					
					<li><a href="visitors.jsp" accesskey="5" title=""><h4 style="color:red">logout</h4></a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
...
PreparedStatement ps1=con.prepareStatement("select * from hotnews  ");
	...
	%>
	<tr>
	<td style="color:white">News</td><td style="color:white"><%=rs.getString(1)%></td>
