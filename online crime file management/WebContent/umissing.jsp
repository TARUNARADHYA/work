...
<div style="background:black">
	<form name="f1" action="missing.jsp" method="get" onsubmit="return validation()">
<center>
 <div></br>
<h3 style="color:white"><b>Missing person Details</b></h3></br></br>
<table  id="ex">
<col width="130">
  <col width="80">
<tr>
 ...
 <tr>
     <td style="color:white"> missing place</td><td><input type="text" name="t2" required></td>
 </tr> 
  <tr >
       <td style="color:white">Date of missing</td> <td><input type="date" width=100% name="t3" required> </td>
 </tr>
 
 <tr>

     <td style="color:white">missing district</td><td><input type="text" name="t4" required></td>
 </tr> 
 <tr>
      <td style="color:white" width=50%>gender</td><td><select name="t5" required>
...
<tr>
     ...
     <td style="color:white">age</td><td><input type="text" name="t6" required></td>
 </tr>
 <tr>

     <td style="color:white">weight</td><td><input type="text" name="t7" required></td>
 </tr>  
 <tr>

     <td style="color:white">Height</td><td><input type="text" name="t8" required></td>
 </tr> 
 <tr>

     <td style="color:white">Brief of case</td><td><input type="text" name="t9" required></td>
 </tr> 
 <tr>

     <td style="color:white">Address of missing</td><td><input type="text" name="t10" required></td>
 </tr> 
  
 <tr >
       <td style="color:white">Date of report</td> <td><input type="date" width=100% name="t11" required> </td>
 </tr>
