...
<center>
 <div></br>
<h3 style="color:white"><b>Crime Details</b></h3></br></br>
<table  id="ex">
<col width="130">
  <col width="80">
<tr>
     <td style="color:white">Suspect name</td><td><input type="text" name="t1" required> </td>
 </tr> 
 <tr>
     <td style="color:white"> Informer name</td><td><input type="text" name="t2" required></td>
 </tr> 

     <td style="color:white"> Informer address</td><td><input type="text" name="t3" required></td>
 </tr> 
  <tr>
       <td style="color:white">Description</td><td><textarea name="t4" required></textarea></td>
 </tr>
 
 <tr >
       <td style="color:white">Date of report</td> <td><input type="date" width=100% name="t5" required> </td>
 </tr>
 
 
</table>

<input type="hidden" name="table" value="registration3">
