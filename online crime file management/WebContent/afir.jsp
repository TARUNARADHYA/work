...
PreparedStatement ps1=con.prepareStatement("select * from fir where status=?  ");
	ps1.setString(1,s);
	...
	<th style="color:white">Address of missing</th>
	<th style="color:white">Date of report</th>
	<th style="color:white">FIR no</th>
	...
	<a href="creg1.jsp?t1=<%=rs.getString(12)%>&table=fir1">delete</a></td>
	<%-- <td style="border: 1px solid black">
